...
HD_PWD='/home/dimitriosa/Downloads/Project/project_ALU/project_ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALUdesign.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALUdesign.tcl
